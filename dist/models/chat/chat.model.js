...
class ChatModel extends Model_1.default {
    ...
    static getAllMessengerChatByCodeUser(data, callback) {
        return __awaiter(this, void 0, void 0, function* () {
            database_1.default.query(sql_1.default.SQL_GET_ALL_MESSENGER_CHAT_BY_CODE_USER(), [data.code_user, data.code_shop, data.limit], callback);
        });
    }
}
