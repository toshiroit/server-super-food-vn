...
router.get(ROUTES_NAME_ADMIN.AUTH.GET_ME, validateTokenAdminShopMiddleware, getMe)
router.get(ROUTES_NAME_ADMIN.AUTH.GET_ME_SHOP, validateTokenAdminShopMiddleware, getMeShop)
